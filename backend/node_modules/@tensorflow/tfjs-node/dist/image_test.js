        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getUint8ArrayFromImage('test_images/image_png_test.png')];
                case 1:
                    uint8array = _c.sent();
    ...
    it('decode png 4 channels', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    beforeNumTensors = tfjs_core_1.memory().numTensors;
                    return [4 /*yield*/, getUint8ArrayFromImage('test_images/image_png_4_channel_test.png')];
                case 1:
                    uint8array = _c.sent();
    ...
    it('decode bmp', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    beforeNumTensors = tfjs_core_1.memory().numTensors;
                    return [4 /*yield*/, getUint8ArrayFromImage('test_images/image_bmp_test.bmp')];
                case 1:
                    uint8array = _c.sent();
    ...
    it('decode jpg', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    beforeNumTensors = tfjs_core_1.memory().numTensors;
                    return [4 /*yield*/, getUint8ArrayFromImage('test_images/image_jpeg_test.jpeg')];
                case 1:
                    uint8array = _c.sent();
    ...
    it('decode gif', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    beforeNumTensors = tfjs_core_1.memory().numTensors;
                    return [4 /*yield*/, getUint8ArrayFromImage('test_images/gif_test.gif')];
                case 1:
                    uint8array = _c.sent();
                    imageTensor = tf.node.decodeImage(uint8array);
                    expect(imageTensor.dtype).toBe('int32');
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    expect(error_2.message)
                        .toBe('Expected image (JPEG, PNG, or GIF), ' +
