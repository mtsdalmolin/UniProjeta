        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, writeFile(testDir, 'foo')];
                case 1:
                    // Create a file at the locatin.
                    _a.sent();
                    handler = tfc.io.getSaveHandlers("file://" + testDir)[0];
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        handler.load()
                            ...
                            tfjs_core_1.test_util.expectArraysClose(new Float32Array(modelArtifacts.weightData), new Float32Array([-1.1, -3.3, -3.3, -7.7]));
                            done();
                        })
                            .catch(function (err) { return done.fail(err.stack); });
                        return [2 /*return*/];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        handler.load()
                            .then(function (modelArtifacts) {
                            tfjs_core_1.test_util.expectArraysClose(new Uint8Array(modelArtifacts.modelTopology), new Uint8Array(modelData));
                            expect(modelArtifacts.weightSpecs).toEqual([
                                {
                                    name: 'dense/kernel',
                                    shape: [3, 1],
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    model.add(tfl.layers.dense({ units: 1, kernelInitializer: 'zeros', inputShape: [1] }));
                    model.compile({ loss: 'meanSquaredError', optimizer: tfc.train.adam(2.5e-2) });
                    xs = tfc.tensor2d([1, 2, 3, 4], [4, 1]);
                    ys = tfc.tensor2d([-1, -3, -5, -7], [4, 1]);
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, tfl.loadLayersModel(loadURL)];
                case 3:
                    model2 = _a.sent();
